...
public class FontConverterV3 {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
      ...
      try {
        ...
        if(args[2] == "b")
        	app = new FontConverterV3(new Font(args[0], Font.PLAIN, Integer.parseInt(args[1])));
        else
        	app = new FontConverterV3(new Font(args[0], Font.BOLD, Integer.parseInt(args[1])));
        ...
        builder.append("// Usage: FontConverterV3 \"font-name\" size r/b \n");
      }
